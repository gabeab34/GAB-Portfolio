  ...
  return (
    <div id = 'bg'>
       <img id = "myPic" src= {myPic} alt= "Me" /> 
        <div id= "aboutMe">
            <ul>
            <li>Hi there! My name is Gabriel Adams Bogar and I'm a full-stack developer with previous experience in the event industry interfacing directly with clients and 
            making sure their expectations become reality.</li> 
            ...
            <li>Click on the GitHub and LinkedIn buttons on the upper left
            to view my profiles on those sites, or click on either my web or video portfolio to view projects that I've previously worked on.</li>
           </ul>
          </div>
    </div>
  );
